...
namespace Kata1TestProject
{
    ...
    public class Probando
    {
        ...
        // correcto ya que desde el punto de vista del jugador1, está perdiendo la partida
        [TestMethod]
        public void PiedraGanaATijeras2()
        {
            Jugada jugada = new Jugada();
            Resultado result = jugada.Play(Gesto.Tijera, Gesto.Piedra);
